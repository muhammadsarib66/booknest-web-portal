...
//   console.log(selectedRoom, 'selected room Datas')
...
//       console.log(data, 'chat rooms data orignal wala')
...
//           console.log(data, 'new message data arha gai ' )
...
//   console.log(chatRooms, 'chat rooms data')
//   return (
...
//         return (
//           <div onClick={()=>handleShowRoomMessages(room)} key={room?._id} className="flex items-center mb-4 p-3 border rounded-lg shadow-sm hover:bg-gray-50">
...
//               />
//             ) : (
//               <div className="w-12 h-12 rounded-full bg-gray-300 flex items-center justify-center text-white text-lg font-semibold mr-4">
//                 {room?.otherUser?.firstname.charAt(0).toUpperCase()}
//               </div>
//             )}
//             <div className="flex-1">
//               <h3 className="font-semibold text-md">{room?.otherUser.firstname}</h3>
...
//           <h1 className="text-2xl font-semibold">{messages?.user?.firstname}</h1>
//         </header>
...
//       className="bg-bgPrimary text-white px-4 py-2 rounded-md ml-2"
//     >
//       Send
//     </button>
//   </div>
